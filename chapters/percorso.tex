...
Innanzitutto per far si che ogni \gls{container}{} possa comunicare con gli altri è stato necessario creare una 
...
Dopo aver configurato il \gls{cluster}{} di \textbf{Apache Kafka}, è stato necessario adattarne il file di \gls{enviroment}{} di \textbf{Apapche Druid} nel seguente modo.
...
\subsubsection{Risultati}
Il risultato ottenuto è stato il seguente (Figura \ref{fig:risultato_lookup}).
\begin{figure}[h]
  \centering

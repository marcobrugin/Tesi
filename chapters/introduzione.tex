...
Le attività di stage descritte in questo documento di tesi si basano sulla progettazione e sviluppo di un 
prototipo di \gls{Data Pipeline}{} basato su Apache Kafka e Apache Druid.\\
Il progetto si dividerà in due parti principali:
\begin{list}{*}{}
    \item realizzazione di una \gls{Data Pipeline}{} basata su Apache Kafka e Apache Druid;
    \item analisi delle prestazioni e funzionalità del sistema realizzato.
\end{list} 

...
\noindent
Per risolvere tale problema è necessario creare due livelli per l'elaborazione dei dati: 
\begin{list}{*}
...
L'approccio comunemente utilizzato per la creazione di \gls{Data Pipeline}{} è quello di utilizzare un \gls{message broker}{} come \textbf{Apache Kafka} e un sistema \gls{olap}{} come \textbf{Apache Druid} per l'analisi dati, operando nel seguente modo:\\
\begin{list}{*}

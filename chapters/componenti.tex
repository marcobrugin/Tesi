...
\begin{list}{*}
    \item \textbf{record dei segmenti}: memorizza i metadati sui segmenti che dovrebbero
    essere disponibili nel sistema (chiamati anche segmenti usati);
    \item \item \textbf{record delle regole}: memorizza le varie regole su dove allocare e deal-
    locare i segmenti del cluster;
...
\noindent
\\
In modalità predefinità \textbf{Apache Druid} utilizza \textbf{Derby}, ma database piu adatti alla produzione

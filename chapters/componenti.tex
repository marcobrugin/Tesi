...
\textbf{Apache Druid} memorizza i dati sotto forma di \gls{datasource}{} molto simili alle tabelle di un tradizionale database relazione e alle serie temporali.
...
\begin{itemize}
    ...
    \item \textbf{metrics}: sono colonne che \textbf{Apache Druid} archivia in forma aggregata e diventano più utili se si utilizza la tecnica del \gls{rollup}{}.
\end{itemize}
\pagebreak
